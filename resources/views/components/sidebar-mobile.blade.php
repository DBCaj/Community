<!-- Mobile sidebar -->
        ...
        <div x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150"
            ...
            class="fixed inset-0 z-20 flex items-end bg-black bg-opacity-50 sm:items-center sm:justify-center md:hidden"></div>
        <aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden"
            ...
            <div class="p-2 bg-[#016e34] text-center">
                <a href="" class="">
                    <img class="mx-auto object-cover w-auto h-12 " src="/assets/logo.png"
                        alt="SOLID">
                </a>
            </div>
                ...
                <ul class="mt-4 text-gray-400">
                    ...
                    <!-- <li class="mb-1">
                        <div class="{{ Request::is('seller-management*') ? 'transform-none transition-none' : 'transform transition-all' }} duration-500 delay-300 -translate-x-12 opacity-0"
                            ...
                            <a class="{{ Request::is('seller-management*') ? 'bg-[#016e34] text-white' : 'hover:text-[#016e34] hover:bg-[#016e34] hover:bg-opacity-[0.15]' }} inline-flex items-center w-11/12 mr-2 rounded-tr-full rounded-br-full text-sm  transition-colors duration-150 "
                                href="">

                                <div
                                    class="{{ Request::is('seller-management*') ? 'pl-8 transform-none transition-none' : 'hover:translate-x-2 transform transition-all' }} px-6 py-3 w-full inline-flex items-center duration-500 ease-out">

                                    <svg class="w-5 h-5" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-tie" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
