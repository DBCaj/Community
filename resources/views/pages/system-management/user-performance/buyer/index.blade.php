...
<h2 class=" text-white transform transition-all opacity-0 translate-y-12 ease-out mb-4"
    data-replace='{ "translate-y-12": "translate-y-0", "opacity-0": "opacity-100"}'>
    <a href="/" class="hover:underline">Dashboard</a> / System Management / User Performance / Buyer Performance
</h2>

<div>

    @include('pages.system-management.user-performance.partials.tabs')
                ...
                <table class="whitespace-nowrap w-full">
                    ...
                    <thead class="text-left border-b border-gray-600 text-gray-600">
                        <tr>
                            ...
                            <th class="p-3 font-normal">Orders</th>
                            <th class="p-3 font-normal">Cancel Orders</th>
                            <th class="p-3 font-normal">Product Reviews</th>
