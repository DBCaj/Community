...
<h2 class=" text-white transform transition-all opacity-0 translate-y-12 ease-out mb-4"
    data-replace='{ "translate-y-12": "translate-y-0", "opacity-0": "opacity-100"}'>
    <a href="/" class="hover:underline">Dashboard</a> / Order Management / Order List
</h2>
            ...
            <div class="overflow-x-auto ">
                ...
                <table class="whitespace-nowrap w-full">
                    ...
                    <thead class="text-left border-b border-gray-600 text-gray-600">
                        <tr>
                            <th class="p-3 font-normal">Order Number</th>
                            <th class="p-3 font-normal">Store Name</th>
                            <th class="p-3 font-normal">Price</th>
                            <th class="p-3 font-normal">Status</th>
                            <th class="p-3 font-normal">Payment Method</th>
                            <th class="p-3 font-normal">Delivery Option</th>
                            <th class="p-3 font-normal">Date Ordered</th>
