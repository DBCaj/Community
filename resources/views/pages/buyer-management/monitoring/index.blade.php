...
<h2 class=" text-white transform transition-all opacity-0 translate-y-12 ease-out mb-4"
    data-replace='{ "translate-y-12": "translate-y-0", "opacity-0": "opacity-100"}'>
    <a href="/" class="hover:underline">Dashboard</a> / Buyer Management / Monitoring
</h2>
...
<div x-data="{openTab: 1, }" >
    ...
    <div  x-show="openTab === 1" class=" bg-white rounded-lg p-4 shadow-md" x-cloak>
        ...
        @include('pages.buyer-management.monitoring.partials.tabs')
    ...
    {{--Login Attempts--}}
    <div  x-show="openTab === 3" class=" bg-white rounded-lg p-4 shadow-md" x-cloak>
            ...
            <div class="overflow-x-auto ">
                ...
                <table class="whitespace-nowrap w-full">
                    ...
                    <thead class="text-left border-b border-gray-600 text-gray-600">
                        <tr>
                            <th class="p-3 font-normal">Name</th>
                            <th class="p-3 font-normal">Abandoned Item</th>
                            <th class="p-3 font-normal">Count</th>
                            <th class="p-3 font-normal">Category</th>
                            <th class="p-3 font-normal">Latest Date</th>
                        </tr>
                    </thead>
