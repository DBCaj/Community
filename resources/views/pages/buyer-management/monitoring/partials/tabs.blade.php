<div class="p-2 pb-0 w-full mb-4 border-b">
    <span class="flex items-baseline">
        ...
        <span class="relative pb-2 mr-2"><a @click="openTab = 3" :class="{'text-[#016e34] cos-underline-active': openTab === 3,'cos-underline text-[#016e34] text-opacity-80 hover:text-opacity-100': openTab != 3 }" class="py-3 px-2 sm:px-6 font-semibold cursor-pointer">Abandoned Item</a></span>
    </span>
</div>
