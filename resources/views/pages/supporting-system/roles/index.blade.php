...
<h2 class=" text-white transform transition-all opacity-0 translate-y-12 ease-out mb-4"
    data-replace='{ "translate-y-12": "translate-y-0", "opacity-0": "opacity-100"}'>
    <a href="/" class="hover:underline">Dashboard</a> / Supporting System / Roles
</h2>

<div x-data="{'showModalRoles': false }">

    {{--Modal - Add Roles --}}
    <div class="overflow-auto" style="background-color: rgba(0,0,0,0.5)" x-show="showModalRoles" :class="{ 'fixed inset-0 z-10 flex items-center justify-center': showModalRoles }" x-cloak>
        <!--Dialog-->
        <div class="bg-white w-11/12 md:max-w-lg mx-auto rounded-lg shadow-lg p-4 text-left" x-show="showModalRoles" @click.away="showModalRoles = false"
        ...
        x-transition:enter-end="opacity-100 scale-100" >
            ...
            <div class="flex justify-between items-center mb-2">
                <p class="font-bold text-[#313346] mb-2 uppercase">Add Roles</p>
                <div class="cursor-pointer z-50" @click="showModalRoles = false">
            ...
            <div class="font-bold text-[#313346] mb-2 uppercase">Role</div>
            ...
            <div class="font-bold text-[#313346] mb-2 uppercase">Page Restrictions</div>
            ...
            <div class="overflow-x-auto max-h-72">
                ...
                <table class="whitespace-nowrap w-full ">
                    ...
                    <tbody class="divide-y ">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400 cursor-point hover:bg-blue-200 transition-all duration-150">
                            <td class="px-3 py-2 ">
                                Delivery Management System (DMS)
                            </td>
                            <td class="px-3 py-2">
                                <select name="" id="" class="outline-none bg-transparent">
    ...
    @include('pages.supporting-system.partials.tabs')
    ...
    <div class=" bg-white rounded-lg p-4 shadow-md">
        ...
        <div class="flex justify-between lg:items-center flex-col lg:flex-row mb-4">
            <div class="flex justify-start mb-4 lg:mb-0">
                <a @click="showModalRoles = true" class="cursor-pointer px-4 py-2 font-medium text-white bg-[#05a85c] hover:bg-[#437a61] transition-all duration-500 rounded-lg flex items-center"><span><svg class="w-4 h-4 text-white mr-2" aria-hidden="true" focusable="false" data-prefix="far" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M368 224H224V80c0-8.84-7.16-16-16-16h-32c-8.84 0-16 7.16-16 16v144H16c-8.84 0-16 7.16-16 16v32c0 8.84 7.16 16 16 16h144v144c0 8.84 7.16 16 16 16h32c8.84 0 16-7.16 16-16V288h144c8.84 0 16-7.16 16-16v-32c0-8.84-7.16-16-16-16z"></path></svg></span> Add Roles</a>
            </div>
